    ...
    const order = await this.orders.create(
      {
        ...
        discountMotif: payload.discountMotif as string | undefined,
        approverUsername: payload.approverUsername as string | undefined,
        approverPassword: payload.approverPassword as string | undefined,
